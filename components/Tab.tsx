...
const Tab = () => {
  ...
  //       "https://dev.dipmarts.com/api/method/dipmarts_app.api.signup"
  //     );
  //     console.log(res.data.message);
  //     setSignup(res.data.message.advertisement);
  ...
  return (
    <>
    {
      ...
      ? (
            ...
            <div className="px-4 py-5 flex-auto">
              <div className="tab-content tab-space">
                <div
                  ...
                  id="link1"
                >
                  <p className="font-bold flex justify-start items-center px-4 ">Register with Phone Number </p>
                ...
                >
                  <div className="flex flex-wrap">
                    ...
                    <span className="text-light-blue-800 underline"  onClick={handleClick}>Forgot Password?</span>
        ...
        <div className=" p-4 flex justify-between items-center" onClick={handleClick}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
